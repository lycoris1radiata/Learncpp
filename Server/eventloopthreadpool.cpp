...
EventLoopThreadPool::EventLoopThreadPool(EventLoop *loop):base_loop_(loop),thread_nums_(0),next_(0)
{
}
...
void tiny_muduo::EventLoopThreadPool::StartLoop()
{
...
EventLoop *tiny_muduo::EventLoopThreadPool::NextLoop()
{
